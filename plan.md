...
### 6.1 信息层次优化 📊
- [x] Game Preview 页面使用分隔线或卡片分组
- [x] 关键信息（比分、赔率）使用更醒目的颜色对比
- [x] 统一各区块的视觉间距
...
### 6.3 键盘导航反馈 ⌨️
- [x] Detail Panel 添加分页指示器（如 "1/10"）
- [x] 显示当前选中比赛的位置提示

### 6.4 加载状态优化 ⏳
- [x] 状态栏显示 loading spinner
- [x] 后台刷新时保持显示已有数据
