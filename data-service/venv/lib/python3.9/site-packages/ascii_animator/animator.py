...
class Animator:
    ...
    def __init__(self, animation=None, speed=Speed.NORMAL, show_axis=False, max_loops=None, first_cycle_sleep=True, color=None):
        """ initialize Animator
        """
        ...
        self.reset_code = self.COLORS['reset'] if self.color_code else ''
    ...
    def _update_terminal(self, lines, cycle_complete):
        ...
        for index, _ in enumerate(self.animation.grid):
            line_content = self.animation.grid[index]
            if self.color_code:
                line_content = f"{self.color_code}{line_content}{self.reset_code}"
